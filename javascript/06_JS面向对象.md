...
但是这样来做的时候我们就**不能对这个属性进行一些限制**：比如这个属性是否是**可以通过delete删除的**？这个 

属性是否**在for-in遍历的时候被遍历出来**呢？
...
![](E:\notes\imgs\javascript\Object.defineProperty.png)
...
![](E:\notes\imgs\javascript\属性描述符类型.png)
...
![](E:\notes\imgs\javascript\JavaScript原型链.png)
...
![](E:\notes\imgs\javascript\Object是所有类的父类.png)
...
// 5.子类的prototype指向新创建的构造函数，并把父类的prototype传过去
Student.prototype = object(Person.prototype)   // 解决Person()多次调用的问题
// 目前的子类的函数类型为Person,需要修改为Student
// 方式一：直接赋值
Student.prototype.constructor = Student
// 方式二： 通过Object.defineProperty()属性描述符
...
![](E:\notes\imgs\javascript\原型继承关系1.png)

![](E:\notes\imgs\javascript\原型继承关系2.png)
